<div class="table-responsive">
	<table class="table" id="basic-datatables">
		...
		<tbody>
			...
			<tr>
				<td><?php echo $no++ ?></td>
				<td><b><?php echo strtoupper($adm->nama_kwaran) ?></b></td>
				...
				<td class="text-right">
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<a class="dropdown-item" href="<?php echo site_url('admin/detil_admin/2/').$adm->id_user ?>" ><i class="fa fa-edit"></i> Edit</a>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content"> 
			...
			<div class="modal-body">
				<form action="<?php echo site_url('admin/tambah_admin/kwaran') ?>" method="post" accept-charset="utf-8">
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							...
							<div class="select2-input">
								<select class="select-kwaran" name="kwaran" class="form-control" style="width: 100%;" required>
...
<script src="<?php echo base_url('assets/myjs/') ?>admin_kwaran.js"></script>
